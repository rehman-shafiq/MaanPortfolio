...
const Header = () => {
    return (
        <>
            ...
            <header className="max-w-7xl mx-auto p-6 animation">
                <div className="flex flex-col md:flex-row items-center justify-center gap-8 ">
                    <div className="w-full md:w-2/4 jus text-center md:text-left mt-30 ">
                        <h2 className="text-lg font-bold text-bold mb-2 ">
                            Welcome to My Portfolio
                        </h2>{/* text-indigo-500 */}
                        <h2 className="text-3xl font-bold ">
                           <strong className=' font-mono-bold animationtexttyping'>
                                Abdul Rehman Shafiq</strong>
                        </h2>
                    ...
                    <div className=" md:w-2/4">
                        <img src={headerimage} alt="Responsive Example Image"
